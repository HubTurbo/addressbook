...
public class PersonListGuiTest extends GuiTestBase {
    ...
    public void dragAndDrop_singlePersonCorrectDrag_listReordered() {
        ...
        personListPanel.navigateToPerson(td.benson); //ensure the destination card is visible
        ...
        personListPanel.navigateToPerson(td.alice); //Make the target card visible
