...
public class FilterPersonsGuiTest extends GuiTestBase {
    ...
    private List<ReadOnlyPerson> filterByName(List<ReadOnlyPerson> originalList, String partialName, boolean isNegative) {
        return originalList.stream()
    ...
    private List<ReadOnlyPerson> filterByCity(List<ReadOnlyPerson> originalList, String partialCityName, boolean isNegative) {
        return originalList.stream()
